...
{
    /// <summary>
    /// SQLite-based implementation of IPersistenceService.
    /// Coordinates repositories, schema creation and initial test data setup.
    /// </summary>
    public class SqlitePersistenceService : IPersistenceService
    {
        ...
        {
            // Basic protection against connection string injection
